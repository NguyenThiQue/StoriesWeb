...
<body>
	<div class="container d-flex justify-content-center">
		${message }
        <form:form action="chapter/insert/${storyID.id }.htm" class="form-floating col-lg-10 justify-content-center row" method="post" modelAttribute="chapter">
...
<%--             <div>${storyID.id }</div> --%>
            <form:textarea class="shadow-none p-3 mb-3 bg-light rounded col-lg-9" path="contents" rows="17"></form:textarea>
<%--             <form:input class="d-none" type="text" path="idStory" value="${storyID.id }"></form:input> --%>
            <div class="d-flex justify-content-center col-lg-12 btn-submit mt-2">
                <button class="btn btn-danger fs-6 fw-bold shadow px-4 py-2 mb-5 rounded">Save</button>
            </div>
        </form:form>
    </div>
</body>
